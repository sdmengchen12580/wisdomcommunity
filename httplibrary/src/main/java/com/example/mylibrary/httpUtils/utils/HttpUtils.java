...
public class HttpUtils {
    ...
    //登录额外获取的三参数
    public static Map<String, String> addLoginMapParams(Context context,Map<String, String> map) {
        String app_system_num = android.os.Build.VERSION.SDK_INT+"";
        String mobile_type = android.os.Build.MODEL;
        String device_id = DeviceIdUtil.getDeviceId(context);
        map.put("app_system_num", app_system_num);
